...
set label at graph 0.1,0.87 "{/:Bold 28.4 ({/Symbol \260}C)}"
...
p 'Tdata_BILBO_AERO_sesgocorr.dat' u 4:11 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymax(x) w l lw 3 t "T_{ERA5} = 0.14 + 0.81T_{OBS} ({/Symbol \260}C)",28.35 lw 2 lc rgb "black" notitle
...
set label at graph 0.14,0.79 "{/:Bold 16.4 ({/Symbol \260}C)}"
...
p 'Tdata_BILBO_AERO_sesgocorr.dat' u 3:12 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymin(x) w l lw 3 t "T_{ERA5} = 2.26 + 0.83T_{OBS} ({/Symbol \260}C)",16.41 lw 2 lc rgb "black" notitle
