...
ifile="../aemet-climatologias_diarias/aemet_ELGOIBAR_corrected.txt"
ifile_era5L="../T_Td_ws_ERA5Land/era5Land_ELGOIBAR_dailymean.txt"
...
ifile_z="geopotential_ERA5_txtfiles/era5Land_GIPUZKOA_ELGOIBAR_zg0_dailymean.txt"
z=lectura_datos(ifile_z)
h_elg=np.mean(z[-3,1].astype(np.float64))

xT_max=tempcorr_obs(df_comp.tmax.values.astype(np.float64),h_elg)
...
xT_min=tempcorr_obs(df_comp.tmin.values.astype(np.float64),h_elg)
...
print("\nTreshold Tmin Elgoibar ==> threshold Tmin Elgoibar ERA5Land\n===================================================================\n")
...
ofile=open("Tdata_ELGOIBAR_sesgocorr_zg0_era5.dat",'w')
ofiles.append(ofile)
