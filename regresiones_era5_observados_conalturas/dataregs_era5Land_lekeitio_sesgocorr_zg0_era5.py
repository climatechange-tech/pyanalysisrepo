...
ifile="../aemet-climatologias_diarias/aemet_LEKEITIO_corrected.txt"
ifile_era5L="../T_Td_ws_ERA5Land/era5Land_LEKEITIO_dailymean.txt"
...
ifile_z="geopotential_ERA5_txtfiles/era5Land_BIZKAIA_LEKEITIO_zg0_dailymean.txt"
z=lectura_datos(ifile_z)
h_lek=np.mean(z[2,1].astype(np.float64))
...
xT_min=tempcorr_obs(df_comp.tmin.values.astype(np.float64),h_lek)
...
print("\nTreshold Tmin Lekeitio ==> threshold Tmin Lekeitio ERA5Land\n===================================================================\n")
...
ofile=open("Tdata_LEKEITIO_sesgocorr_zg0_era5.dat",'w')
ofiles.append(ofile)
