...
yT_max=tempcorr_ERA5Land(df_comp.tmax_era5L.values.astype(np.float64),h_igeldo)
...
yT_min=tempcorr_ERA5Land(df_comp.tmin_era5L.values.astype(np.float64),h_igeldo)
