...
fit ymax(x) 'wsT_data_BILBO_AERO.dat' u 4:11 via A,B

p 'wsT_data_BILBO_AERO.dat' u 4:11 w p lt 7 ps 1 lc rgb "red" notitle,\
...
fit ymin(x) 'wsT_data_BILBO_AERO.dat' u 3:12 via C,D

p 'wsT_data_BILBO_AERO.dat' u 3:12 w p lt 7 ps 1 lc rgb "red" notitle,\
