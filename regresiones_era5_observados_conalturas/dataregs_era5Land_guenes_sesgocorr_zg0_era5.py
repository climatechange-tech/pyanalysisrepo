...
ifile="../aemet-climatologias_diarias/aemet_GUENES_corrected.txt"
ifile_era5L="../T_Td_ws_ERA5Land/era5Land_GUENES_dailymean.txt"
...
ifile_z="geopotential_ERA5_txtfiles/era5Land_BIZKAIA_GUENES_zg0_dailymean.txt"
z=lectura_datos(ifile_z)
h_gue=np.mean(z[1,1].astype(np.float64))

xT_max=tempcorr_obs(df_comp.tmax.values.astype(np.float64),h_gue)
...
xT_min=tempcorr_obs(df_comp.tmin.values.astype(np.float64),h_gue)
...
print("\nTreshold Tmax Gueñes ==> threshold Tmax Gueñes ERA5Land\n===================================================================\n")
...
ofile=open("Tdata_GUENES_sesgocorr_zg0_era5.dat",'w')
ofiles.append(ofile)
