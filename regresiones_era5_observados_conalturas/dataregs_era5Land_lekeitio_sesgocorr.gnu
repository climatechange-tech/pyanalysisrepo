...
set label at graph 0.1,0.82 "{/:Bold 29.3 ({/Symbol \260}C)}"
...
p 'Tdata_LEKEITIO_sesgocorr.dat' u 1:2 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymax(x) w l lw 3 t "T_{ERA5} = -2.72 + 1.07T_{OBS} ({/Symbol \260}C)",29.31 lw 2 lc rgb "black" notitle
...
p 'Tdata_LEKEITIO_sesgocorr.dat' u 3:4 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymin(x) w l lw 3 t "T_{ERA5} = -2.40 + 1.01T_{OBS} ({/Symbol \260}C)",16.71 lw 2 lc rgb "black" notitle
