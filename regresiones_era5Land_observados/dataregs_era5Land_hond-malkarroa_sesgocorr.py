...
ifile="../aemet-climatologias_diarias/aemet_HONDARRIBIA-MALKARROA_corrected.txt"
ifile_era5L="../T_Td_ws_ERA5Land/era5Land_HONDARRIBIA_dailymean.txt"
...
h_corr=-int(z[3,1])+int(z[3,-1])

xT_max=df_comp.tmax.values.astype(np.float64)
yT_max=tempcorr_ERA5Land(df_comp.tmax_era5L.values.astype(np.float64),h_corr)
...
yT_min=tempcorr_ERA5Land(df_comp.tmin_era5L.values.astype(np.float64),h_corr)
...
print("\nTreshold Tmax Hondarribia ==> threshold Tmax Hondarribia ERA5Land\n===================================================================\n")
print(("%i ºC ==> %7.2f ºC" %(thres_max,thres_era5L_max)))

thres_min=19
thres_era5L_min = intercept2 + slope2*thres_min

print("\nTendencia Tmin Hondarribia\n=====================================\n")
...
print("\nTreshold Tmin Hondarribia ==> threshold Tmin Hondarribia ERA5Land\n===================================================================\n")
...
ofile=open("Tdata_HONDARRIBIA_sesgocorr.dat",'w')
ofiles.append(ofile)
