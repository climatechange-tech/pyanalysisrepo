...
ifile="../aemet-climatologias_diarias/aemet_PAMPLONA_corrected.txt"
ifile_era5L="../T_Td_ws_ERA5Land/era5Land_PAMPLONA-AERO_dailymean.txt"
...
h_zumarraga=z[-2,-1].astype(np.float64)


xT_max=df_comp.tmax.values.astype(np.float64)
yT_max=tempcorr_ERA5Land(df_comp.tmax_era5L.values.astype(np.float64),h_zumarraga)
...
yT_min=tempcorr_ERA5Land(df_comp.tmin_era5L.values.astype(np.float64),h_zumarraga)
...
print("\nTreshold Tmin Pamplona ==> threshold Tmin Pamplona ERA5Land\n===================================================================\n")
...
ofile=open("Tdata_PAMPLONA_AERO_sesgocorr.dat",'w')
ofiles.append(ofile)
