...
set label at graph 0.1,0.87 "{/:Bold 32.1 ({/Symbol \260}C)}"
...
p 'Tdata_GUENES.dat' u 1:2 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymax(x) w l lw 3 t "T_{ERA5} = -0.73 + 0.94T_{OBS} ({/Symbol \260}C)",32.12 lw 2 lc rgb "black" notitle
...
set label at graph 0.1,0.84 "{/:Bold 16.1 ({/Symbol \260}C)}"
...
p 'Tdata_GUENES.dat' u 3:4 w p lt 7 ps 1 lc rgb "red" notitle,\
  ymin(x) w l lw 3 t "T_{ERA5} = -0.61 + 0.98T_{OBS} ({/Symbol \260}C)",16.13 lw 2 lc rgb "black" notitle
